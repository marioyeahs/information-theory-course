...
str = extractFileText('/Users/jenniffercervantes/Documents/MATLAB/information-theory-course/Tarea1/Don Miguel Ruiz - Los Cuatro Acuerdos_ Una Guia Practica para la Libertad Personal (1999).docx');
file_char = char(str);
